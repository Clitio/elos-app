...
const categories = [
  ...
  { value: 'accommodation', label: 'Acomodacao' },
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Pesquisar</h1>
        <p className="text-gray-500">Encontra profissionais e estabelecimentos brasileiros em Cork</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        <input
          ...
          placeholder="Pesquisa por nome, area ou localizacao..."
      ...
      {filtered.length === 0 ? (
        ...
        <>
          <p className="text-gray-500 text-sm mb-6">{filtered.length} resultado(s) encontrado(s)</p>
